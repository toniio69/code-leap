...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-background text-foreground antialiased">
        <section class="from-background to-muted/50 relative isolate flex min-h-dvh w-full flex-col items-center justify-center overflow-hidden bg-linear-to-br">
            <div class="relative z-10 container mx-auto flex min-h-dvh flex-col items-center justify-center px-4 py-12">
                <div class="relative w-full max-w-lg p-8 shadow-2xl rounded-lg border bg-card text-card-foreground">
                    <div class="mb-8 flex flex-col items-center">
                        ...
                        <h1 class="mb-2 text-center text-2xl font-bold tracking-tight">Create Your Account</h1>
                        <p class="text-muted-foreground text-center text-sm">Get started by filling out the form below</p>
                    </div>
                    ...
                    @if (Route::has('socialite.redirect'))
                        <div class="relative my-6 text-center">
                            ...
                            <div class="relative flex justify-center text-xs uppercase">
                                <span class="bg-card text-muted-foreground px-2">Or sign up with</span>
                            </div>
                        </div>
                    ...
                    <p class="text-muted-foreground relative z-10 mt-8 max-w-lg px-8 text-center text-xs text-balance">
                        By creating an account, you agree to Code Leap's&nbsp;
